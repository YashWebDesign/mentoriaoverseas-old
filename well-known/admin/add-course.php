...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
			    ...
			    <div class="form-group row">
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="ielts_no_band_less_than"  style="text-transform: capitalize;border-radius:350px">
                     ...
                     <div class="form-group row">
				  <label for="basic-input" class="col-sm-3 col-form-label">PTE Overall</label>
                    
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="pte_overall"  style="text-transform: capitalize;border-radius:350px">
				  </div>
                     ...
                     <div class="form-group row">
				  <label for="basic-input" class="col-sm-3 col-form-label">PTE No Bands Less Than</label>
                    
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="pte_no_bands"  style="text-transform: capitalize;border-radius:350px">
				  </div>
                     ...
                     <div class="form-group row">
				  <label for="basic-input" class="col-sm-3 col-form-label">TOEFL iBT Overall</label>
                    
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="toefl_ibt_overall"  style="text-transform: capitalize;border-radius:350px">
				  </div>
                     ...
                     <div class="form-group row">
				  <label for="basic-input" class="col-sm-3 col-form-label">TOEFL iBT no Bands Less Than</label>
                    
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="toefl_no_bands"  style="text-transform: capitalize;border-radius:350px">
				  </div>
                    
				</div>
                     
                     <div class="form-group row">
				  <label for="basic-input" class="col-sm-3 col-form-label">DTE Score</label>
                    
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="dte"  style="text-transform: capitalize;border-radius:350px">
				  </div>
     ...
     $sql = "INSERT INTO course (course_name,intakes,duration,campus,url,application_deadline,application_fee,yearly_tuition_fee,ielts_overall,ielts_no_band_less_than,test_requirements,entry_requirements,remarks,pte_overall,pte_no_bands,toefl_ibt_overall,toefl_no_bands,dte) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$stmt->bind_param("ssssssssssssssssss", $course_name,$intakes,$duration,$campus,$url,$application_deadline,$application_fee,$yearly_tuition_fee,$ielts_overall,$ielts_no_band_less_than,$test_requirements,$entry_requirements,$remarks,$pte_overall,$pte_no_bands,$toefl_ibt_overall,$toefl_no_bands,$dte);
    $stmt->execute();
