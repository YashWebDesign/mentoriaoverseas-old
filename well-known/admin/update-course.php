			 ...
			 <?php
				...
				<div class="form-group row">
				 ...
				 <div class="form-group row">
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="pte_overall"  style="text-transform: capitalize;border-radius:350px" value="<?php echo $row["pte_overall"]; ?>">
				  </div>
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="pte_no_bands"  style="text-transform: capitalize;border-radius:350px" value="<?php echo $row["pte_no_bands"]; ?>">
				  </div>
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="toefl_ibt_overall"  style="text-transform: capitalize;border-radius:350px" value="<?php echo $row["toefl_ibt_overall"]; ?>">
				  </div>
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="toefl_no_bands"  style="text-transform: capitalize;border-radius:350px" value="<?php echo $row["toefl_no_bands"]; ?>">
				  </div>
				  ...
				  <div class="col-sm-9">
					<input type="text" id="basic-input" class="form-control"  name="dte"  style="text-transform: capitalize;border-radius:350px" value="<?php echo $row["dte"]; ?>">
				  </div>
