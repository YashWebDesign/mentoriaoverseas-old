...
$title = isset($_POST['title']) ? urldecode($_POST['title']) : null;
...
?>  
    ...
    <input type="hidden" name="title" value="<?php echo $row["title"]; ?>">
                                                ...
                                                <h6 class="title"><a href="" onclick="submitForm('<?php echo $titleForUrl; ?>', '<?php echo $row["id"]; ?>'); return false;"><?php echo implode(' ', array_slice(explode(' ', $title), 0, 8)) ?>...</a></h6>
