                ...
                <div class="row row--30">
                    <div class="col-lg-8">
                        <div class="course-details-content course-details-3">
                            ...
                            <center><a href="apply-now" class="edu-btn btn-medium enroll-btn">Apply Now</a></center>
                                ...
                                <div class="inner">
                                    <div class="content">
                                        ...
                                        <ul class="course-item">
                                            ...
                                            <li>
                                                <span class="label"><img class="svgInject" src="assets/images/svg-icons/books.svg" alt="book icon">Lessons:</span>
